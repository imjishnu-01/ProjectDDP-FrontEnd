...
<div class="container flex justify-center items-center h-screen">
	<form class="card p-2 flex flex-col gap-2 w-100" on:submit|preventDefault={registerUser}>
		...
		<hr class="m-2">
		<label>
			<input type="checkbox" class="checkbox" bind:checked={isChecked} /> I acknowledge that I have read and agree to the <button type="button" on:click={termsOfUsage} class="text-blue-600">Terms of Usage</button> for this service.
		</label>
